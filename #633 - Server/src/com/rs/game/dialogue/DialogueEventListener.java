...
public abstract class DialogueEventListener implements DialogueFaceExpression {
	...
	public void listenToDialogueEvent(int button){
		...
		case 2:
		{
			//TODO: Seems accurate, however item is a bit far away, can use a cache editor to move it though perhaps.
		...
		case 3:
		{
			 //TODO: Fix option interaction & option text displaying
		     ...
		     player.getInterfaceManager().sendChatBoxInterface(229 + options.length -1);
		     player.getPackets().sendIComponentText(229, 2, event.getText());
