...
public class WarriorsGuild extends Controller {
	...
	private void submitDummyHit(final WorldObject object) {
		player.setNextAnimation(new Animation(PlayerCombat.getWeaponAttackEmote(player.getEquipment().getWeaponId(),
	...
	private void sendShieldInterfaces() {
		player.getInterfaceManager().setWindowInterface(player.getInterfaceManager().hasRezizableScreen() ? 116 : 176,
				411);
