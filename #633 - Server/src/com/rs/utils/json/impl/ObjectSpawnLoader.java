package com.rs.utils.json.impl;
...
import com.rs.utils.json.GsonLoader;
...
public class ObjectSpawnLoader extends GsonLoader<ObjectSpawnLoader.ObjectSpawn> {
	...
	public static final void loadObjectSpawns(int regionId) {
		...
		for (ObjectSpawn spawn : spawns) {
			World.spawnObject(new WorldObject(spawn.getId(), (short) spawn.getType(), (short) spawn.getRotation(), spawn.getX(), spawn.getY(), spawn.getPlane()));
		}
	}
