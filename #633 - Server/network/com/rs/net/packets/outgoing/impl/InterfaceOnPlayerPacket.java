...
@OutgoingPacketSignature(packetId = 34, packetSize = 11, description = "An Interface that's used onto a Player (Magic, etc..)")
public class InterfaceOnPlayerPacket implements OutgoingPacket {
