...
public class Spiritguthatrice extends Familiar {
	...
	public Spiritguthatrice(Player owner, Pouch pouch, WorldTile tile, int mapAreaNameHash,
	...
	public boolean submitSpecial(Object object) {
		...
		target.ifPlayer(targetSelected -> {
			int level = targetSelected.getSkills().getLevelForXp(Skills.ATTACK);
			int drained = 3;
			if (level - drained > 0)
				drained = level;
			targetSelected.getSkills().drainLevel(Skills.ATTACK, drained);
		});
