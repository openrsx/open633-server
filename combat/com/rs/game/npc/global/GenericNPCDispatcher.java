...
public class GenericNPCDispatcher {
    ...
    public static void load() {
        List<GenericNPC> mobLoader = ReflectionUtils.getSubclassesOf(GenericNPC.class);
        mobLoader.forEach(npcs -> NPC.put(npcs.getClass().getAnnotation(GenericNPCSignature.class), npcs));
        LogUtility.log(LogUtility.LogType.INFO, "Registered " + NPC.size() + " npcs with npc signatures.");
    }
}